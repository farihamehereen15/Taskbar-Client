...
const Footer = () => {
    return (
        <footer className="footer items-center md:px-32 px-12 py-8 mt-5 bg-neutral text-neutral-content">
            ...
            <div className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                ...
                <div className='flex justify-center'>
                    <button className='text-4xl mr-3 p-3 bg-slate-700 rounded-full shadow-md'><a href='https://www.linkedin.com/in/fariha-mehereen/' target='blank'><FaLinkedin /></a></button>
                    <button className='text-4xl mr-3 p-3 bg-slate-700 rounded-full shadow-md'><a href='https://github.com/farihamehereen15' target='blank'><AiFillGithub /></a></button>
                    <button className='text-4xl mr-3 p-3 bg-slate-700 rounded-full shadow-md'><a href='https://www.facebook.com/fariha.mehereen' target='blank'><FaFacebook /></a></button>
